...
def parse_argument(sys_argv):
    ...
    parser.add_argument(
        ...
        help='The number of outer iterations')
    parser.add_argument(
        '--freq_lambda', type=int, default=5,
        help='Frequency of lambda update')
    parser.add_argument(
        '--freq_w', type=int, default=1,
        help='Frequency of w update')
    ...
    parser.add_argument(
        '--use_cd', type=int, default='1',
        help='Whether use central difference')
    ...
    parser.add_argument(
        '--csv_file', default=None, type=str,
        help='CSV file to record the stats')
    # Algorithm-dependent parameters
    parser.add_argument(
        '--F2SA_validation_sampler',
        type=str,
        default=None,
